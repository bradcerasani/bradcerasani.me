...
date: 2018-01-01
dateRange: 2017–2018
image: ./designing-a-home-cover.jpg
status: live
---

import { Caption, Figure, Grid, GridItem, ImageCompare } from 'src/components';
...
import Video from 'src/components/RawVideo.astro';

import image1 from './0S7A7533-small-sketchup.jpg';
import image2 from './0S7A7533-small.jpg';
import image3 from './0S7A7604-small-before.jpg';
import image4 from './0S7A7604-small.jpg';
...
<Figure size="large">
  <Grid gutter="1.125rem">
    <GridItem width={{ base: '50%' }}>
      <Image
        src="./IMG_0148.jpg"
        sizes="(max-width: 700px) 50vw, (max-width: 999px) 356px, (min-width: 1000px) 446px"
        widths={[250, 356, 446, 712, 892, 1000]}
        alt="Kitchen before"
        loading="eager"
      />
    </GridItem>
    <GridItem width={{ base: '50%' }}>
      <Image
        ...
        sizes="(max-width: 700px) 50vw, (max-width: 999px) 356px, (min-width: 1000px) 446px"
        widths={[250, 356, 446, 712, 892, 1000]}
        alt="Jackhammering concrete out of kitchen"
        loading="eager"
      />
    </GridItem>
  </Grid>
  <Caption>Surprise concrete under the kitchen floor</Caption>
</Figure>
...
<ImageCompare
  name="comparison-2"
  caption="Comparison of mid-demolition and final"
  itemOne={image3}
  itemTwo={image4}
  position={50}
  size="large"
...
<PostImage size="full" src="./0S7A7712.jpg" alt="Dining room" />

<PostImage size="full" src="./0S7A7686.jpg" alt="Dining room/kitchen" />

<PostImage size="full" src="./0S7A7658.jpg" alt="Dining room" />
...
<Figure size="large">
  <Grid gutter="1.125rem">
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Video src="./light-assembly.mp4" />
    </GridItem>
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        src="./IMG_0164x.jpg"
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="Aluminum channel with LED strips on sides"
      />
    </GridItem>
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        ...
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="Dry-fitting aluminum channel assemblies with tension rods"
      />
    </GridItem>
  </Grid>
</Figure>
  ...
  <Grid gutter="1.125rem">
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        ...
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="LED drivers and controllers"
      />
    </GridItem>
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        ...
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="Aluminum channel installation"
      />
    </GridItem>
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        ...
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="Testing independent fixture control"
      />
    </GridItem>
  </Grid>
</Figure>
  ...
  <Grid gutter="1.125rem">
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        ...
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="Installed LED channel corner with blue light on"
      />
    </GridItem>
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Image
        ...
        sizes="(max-width: 480px) 100vw, (max-width: 700px) 33vw, (max-width: 999px) 228px, (min-width: 1000px) 288px"
        widths={[235, 295, 470, 590, 720, 960]}
        alt="Installed LED channel corner with light off"
      />
    </GridItem>
    <GridItem width={{ sm: '33.3334%' }} style={{marginBottom: '2.5rem'}}>
      <Video src="./controller-2.mp4" />
    </GridItem>
  </Grid>
</Figure>
...
<PostImage size="full" src="./0S7A8615.jpg" caption="Main floor powder room" />
...
<PostVideo
  size="large"
  src="./occupancy-demo-color-corrected.mp4"
