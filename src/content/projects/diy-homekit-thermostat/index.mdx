...
I find it useful to think about systems design in terms of inputs and outputs. When considering a thermostat in a standard heat-only system, the I/O might be:
