...
date: 2013-05-08
image: ./herman-miller-lifework.jpg
cta: Read Interview
status: live
---
...
<PostImage src="./lifework-wide_3.jpg" size="large" alt="Brad Cerasani × Herman Miller Lifework" loading="eager" />
...
<PostImage src="./lifework-wide_1.jpg" size="large" alt="Brad Cerasani × Herman Miller Lifework" />
...
<PostImage
  src="./lifework-support_2.jpg"
  size="large"
  alt="Brad Cerasani × Herman Miller Lifework"
/>
...
<PostImage src="./lifework-wide_2.jpg" size="large" alt="Brad Cerasani × Herman Miller Lifework" />

<PostImage
  src="./lifework-support_1.jpg"
  size="large"
  alt="Brad Cerasani × Herman Miller Lifework"
/>
