---
title: Tesla software <br /> problems in winter
description: When Designed in California™ meets -40°.
date: 2021-03-29
image: ./share-bright.jpg
video: ./climate-control-compressed.mp4
skipHero: true
status: live
---
...
I've driven a Model 3 for two winters now, and generally speaking it's a good cold weather car. I live in the coldest major city in Canada, and I do _not_ miss pumping gas in -40°. The ability to preheat the car in a closed garage without worrying about fumes is also really nice.
...
I collected data from all of my drives in temperatures below 0°C (32°F) over the course of two winters, and filtered trips that were less than 5 km. With a sample size of 181 drives, the average accuracy of my Tesla's range indicator in these conditions was 44.2%[^1]. This means on average, for every 1 km driven, the range remaining went down by more than 2 km. The accuracy varied considerably as well, from 71% to as low as 21% in extreme cold.

> This means on average, for every 1 km driven, the range remaining went down by more than 2 km.
...
Unlike Anti-lock Braking Systems (ABS), there does not appear to be any stutter or cadence in a Tesla's application of regen. To regain control and unlock the wheels from a regen-induced slide, one must counter-intuitively resume pressure on the accelerator. A Tesla does not seem to recognize when it's experiencing regen-induced traction loss, or presumably it would stutter or reduce the amount of regen applied and compensate with the brakes.
...
<PostVideo
  size="large"
  src="./climate-control-compressed.mp4"
  caption="In a Model 3's climate control, the windshield vents turn themselves off when in auto mode"
/>
...
<PostImage
  src="./IMG_0425.jpg"
  size="large"
  caption="Night mode is automatically enabled at sunset, but at some latitudes sunset is a poor indicator of ambient light level"
/>
...
<PostImage
  src="./0S7A3613.jpg"
  size="large"
  caption="Snowflake icon with inexplicable drop shadow"
/>
...
<PostImage src="./0S7A3592.jpg" size="large" caption="Snowflake icon in broader context" />
